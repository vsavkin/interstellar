...
import './important-component-17.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent17Props {}

export function ImportantComponent17(props: ImportantComponent17Props) {
  return (
    <div>
      <h1>Welcome to important-component-17!</h1>
    </div>
  );
}

export default ImportantComponent17;

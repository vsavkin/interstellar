...
import './important-component-58.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent58Props {}

export function ImportantComponent58(props: ImportantComponent58Props) {
  return (
    <div>
      <h1>Welcome to important-component-58!</h1>
    </div>
  );
}

export default ImportantComponent58;

...
import './important-component-26.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent26Props {}

export function ImportantComponent26(props: ImportantComponent26Props) {
  return (
    <div>
      <h1>Welcome to important-component-26!</h1>
    </div>
  );
}

export default ImportantComponent26;

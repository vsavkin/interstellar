...
import './important-component-197.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent197Props {}

export function ImportantComponent197(props: ImportantComponent197Props) {
  return (
    <div>
      <h1>Welcome to important-component-197!</h1>
    </div>
  );
}

export default ImportantComponent197;

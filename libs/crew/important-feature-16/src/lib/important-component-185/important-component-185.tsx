...
import './important-component-185.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent185Props {}

export function ImportantComponent185(props: ImportantComponent185Props) {
  return (
    <div>
      <h1>Welcome to important-component-185!</h1>
    </div>
  );
}

export default ImportantComponent185;

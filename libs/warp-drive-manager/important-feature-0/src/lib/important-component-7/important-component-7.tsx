...
import './important-component-7.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent7Props {}

export function ImportantComponent7(props: ImportantComponent7Props) {
  return (
    <div>
      <h1>Welcome to important-component-7!</h1>
    </div>
  );
}

export default ImportantComponent7;

...
import './important-component-194.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent194Props {}

export function ImportantComponent194(props: ImportantComponent194Props) {
  return (
    <div>
      <h1>Welcome to important-component-194!</h1>
    </div>
  );
}

export default ImportantComponent194;

...
import './important-component-234.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent234Props {}

export function ImportantComponent234(props: ImportantComponent234Props) {
  return (
    <div>
      <h1>Welcome to important-component-234!</h1>
    </div>
  );
}

export default ImportantComponent234;

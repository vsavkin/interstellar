...
import './important-component-128.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent128Props {}

export function ImportantComponent128(props: ImportantComponent128Props) {
  return (
    <div>
      <h1>Welcome to important-component-128!</h1>
    </div>
  );
}

export default ImportantComponent128;

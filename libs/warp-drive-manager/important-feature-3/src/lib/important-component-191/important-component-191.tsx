...
import './important-component-191.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent191Props {}

export function ImportantComponent191(props: ImportantComponent191Props) {
  return (
    <div>
      <h1>Welcome to important-component-191!</h1>
    </div>
  );
}

export default ImportantComponent191;

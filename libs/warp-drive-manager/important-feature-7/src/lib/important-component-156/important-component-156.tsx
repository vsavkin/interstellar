...
import './important-component-156.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent156Props {}

export function ImportantComponent156(props: ImportantComponent156Props) {
  return (
    <div>
      <h1>Welcome to important-component-156!</h1>
    </div>
  );
}

export default ImportantComponent156;

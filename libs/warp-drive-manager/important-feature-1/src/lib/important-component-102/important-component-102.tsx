...
import './important-component-102.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent102Props {}

export function ImportantComponent102(props: ImportantComponent102Props) {
  return (
    <div>
      <h1>Welcome to important-component-102!</h1>
    </div>
  );
}

export default ImportantComponent102;

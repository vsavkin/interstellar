...
import './important-component-123.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent123Props {}

export function ImportantComponent123(props: ImportantComponent123Props) {
  return (
    <div>
      <h1>Welcome to important-component-123!</h1>
    </div>
  );
}

export default ImportantComponent123;

...
import './important-component-129.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent129Props {}

export function ImportantComponent129(props: ImportantComponent129Props) {
  return (
    <div>
      <h1>Welcome to important-component-129!</h1>
    </div>
  );
}

export default ImportantComponent129;

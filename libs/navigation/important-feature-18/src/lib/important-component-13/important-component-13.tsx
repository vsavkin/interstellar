...
import './important-component-13.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent13Props {}

export function ImportantComponent13(props: ImportantComponent13Props) {
  return (
    <div>
      <h1>Welcome to important-component-13!</h1>
    </div>
  );
}

export default ImportantComponent13;

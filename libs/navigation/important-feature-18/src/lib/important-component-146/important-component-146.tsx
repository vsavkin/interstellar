...
import './important-component-146.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent146Props {}

export function ImportantComponent146(props: ImportantComponent146Props) {
  return (
    <div>
      <h1>Welcome to important-component-146!</h1>
    </div>
  );
}

export default ImportantComponent146;

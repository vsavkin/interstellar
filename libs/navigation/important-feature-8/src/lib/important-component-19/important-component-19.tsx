...
import './important-component-19.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent19Props {}

export function ImportantComponent19(props: ImportantComponent19Props) {
  return (
    <div>
      <h1>Welcome to important-component-19!</h1>
    </div>
  );
}

export default ImportantComponent19;

...
import './important-component-187.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent187Props {}

export function ImportantComponent187(props: ImportantComponent187Props) {
  return (
    <div>
      <h1>Welcome to important-component-187!</h1>
    </div>
  );
}

export default ImportantComponent187;

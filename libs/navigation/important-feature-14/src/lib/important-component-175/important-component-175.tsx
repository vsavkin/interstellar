...
import './important-component-175.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent175Props {}

export function ImportantComponent175(props: ImportantComponent175Props) {
  return (
    <div>
      <h1>Welcome to important-component-175!</h1>
    </div>
  );
}

export default ImportantComponent175;

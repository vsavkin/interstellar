...
import './important-component-65.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent65Props {}

export function ImportantComponent65(props: ImportantComponent65Props) {
  return (
    <div>
      <h1>Welcome to important-component-65!</h1>
    </div>
  );
}

export default ImportantComponent65;

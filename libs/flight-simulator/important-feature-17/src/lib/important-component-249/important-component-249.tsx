...
import './important-component-249.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent249Props {}

export function ImportantComponent249(props: ImportantComponent249Props) {
  return (
    <div>
      <h1>Welcome to important-component-249!</h1>
    </div>
  );
}

export default ImportantComponent249;

...
import './important-component-163.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent163Props {}

export function ImportantComponent163(props: ImportantComponent163Props) {
  return (
    <div>
      <h1>Welcome to important-component-163!</h1>
    </div>
  );
}

export default ImportantComponent163;

...
import './important-component-76.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent76Props {}

export function ImportantComponent76(props: ImportantComponent76Props) {
  return (
    <div>
      <h1>Welcome to important-component-76!</h1>
    </div>
  );
}

export default ImportantComponent76;

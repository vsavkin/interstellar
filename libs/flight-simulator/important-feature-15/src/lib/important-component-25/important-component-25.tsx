...
import './important-component-25.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent25Props {}

export function ImportantComponent25(props: ImportantComponent25Props) {
  return (
    <div>
      <h1>Welcome to important-component-25!</h1>
    </div>
  );
}

export default ImportantComponent25;

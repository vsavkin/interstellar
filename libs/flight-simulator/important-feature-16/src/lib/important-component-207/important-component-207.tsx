...
import './important-component-207.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent207Props {}

export function ImportantComponent207(props: ImportantComponent207Props) {
  return (
    <div>
      <h1>Welcome to important-component-207!</h1>
    </div>
  );
}

export default ImportantComponent207;

...
import './important-component-12.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent12Props {}

export function ImportantComponent12(props: ImportantComponent12Props) {
  return (
    <div>
      <h1>Welcome to important-component-12!</h1>
    </div>
  );
}

export default ImportantComponent12;

...
import './important-component-18.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent18Props {}

export function ImportantComponent18(props: ImportantComponent18Props) {
  return (
    <div>
      <h1>Welcome to important-component-18!</h1>
    </div>
  );
}

export default ImportantComponent18;

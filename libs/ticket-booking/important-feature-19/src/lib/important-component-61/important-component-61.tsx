...
import './important-component-61.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent61Props {}

export function ImportantComponent61(props: ImportantComponent61Props) {
  return (
    <div>
      <h1>Welcome to important-component-61!</h1>
    </div>
  );
}

export default ImportantComponent61;

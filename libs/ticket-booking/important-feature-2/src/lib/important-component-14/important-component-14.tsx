...
import './important-component-14.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent14Props {}

export function ImportantComponent14(props: ImportantComponent14Props) {
  return (
    <div>
      <h1>Welcome to important-component-14!</h1>
    </div>
  );
}

export default ImportantComponent14;

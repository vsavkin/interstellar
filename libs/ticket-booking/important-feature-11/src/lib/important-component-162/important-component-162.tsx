...
import './important-component-162.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent162Props {}

export function ImportantComponent162(props: ImportantComponent162Props) {
  return (
    <div>
      <h1>Welcome to important-component-162!</h1>
    </div>
  );
}

export default ImportantComponent162;

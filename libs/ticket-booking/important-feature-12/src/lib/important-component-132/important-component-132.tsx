...
import './important-component-132.module.css';

/* eslint-disable-next-line */
export interface ImportantComponent132Props {}

export function ImportantComponent132(props: ImportantComponent132Props) {
  return (
    <div>
      <h1>Welcome to important-component-132!</h1>
    </div>
  );
}

export default ImportantComponent132;
